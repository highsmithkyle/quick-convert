...
//         exec(
//           `magick -size ${width}x${height} xc:"rgba(${parseInt(color.substring(1, 3), 16)},${parseInt(color.substring(3, 5), 16)},${parseInt(color.substring(5, 7), 16)},${opacity})" "${overlayPath}"`,
//           (overlayError) => {
//             if (overlayError) {
