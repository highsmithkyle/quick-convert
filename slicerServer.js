...
//   const videoPath3 = req.files["video3"][0].path;
...
//   const tempOutputPath3 = path.join(__dirname, "processed", `temp_output3_${Date.now()}.mp4`);
//   const finalOutputPath = path.join(__dirname, "processed", `final_output_${Date.now()}.mp4`);
...
//       await processVideo(videoPath3, slices3, tempOutputPath3);

//       await concatenateVideos([tempOutputPath1, tempOutputPath2, tempOutputPath3], finalOutputPath);
