document.addEventListener("DOMContentLoaded", function () {
  ...
  // Display original image details and reset fields
  imageInput.addEventListener("change", function (event) {
    ...
    if (file) {
      ...
      // Reset form fields if no file is selected
      resetFormFields();
    }
  });
  ...
  targetWidthInput.addEventListener("input", function () {
    ...
    if (width > 0 && enteredWidth > 0) {
      ...
      targetHeightInput.value = ""; // Clear if invalid
    }
  });
  /* [ADDED CODE END] */
  ...
  // [ADDED CODE] - Function to reset form fields
  function resetFormFields() {
    // Reset color picker to default
    colorPicker.value = "#000000";
    colorValueDisplay.textContent = "#000000";

    // Reset target width and height
    targetWidthInput.value = "";
    targetHeightInput.value = "";

    // Reset gradient size to default
    gradientSizeSelect.value = "full";

    // Reset height of colored block
    heightInput.value = "";

    // Clear suggested colors
    suggestedColorsContainer.innerHTML = "";

    // Clear final image and its details
    finalImage.src = "";
    finalImageDimensions.textContent = "";
    finalImageSize.textContent = "";
  }
});
