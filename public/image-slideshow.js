...
//   // New Ratio Alert Modal Elements
//   const ratioAlertModal = document.getElementById("ratioAlertModal");
//   const ratioAlertCloseButton = document.getElementById("ratioAlertCloseButton");
...
//         // Set cropSizeSelector to 'custom' by default
//         cropSizeSelector.value = "custom";
//         const cropSizeContainer = cropSizeSelector.parentElement;

//         // Show or hide cropSizeSelector based on handlingOption
//         if (handlingOption.value === "headerBackground") {
//           cropSizeSelector.value = "1000x400";
//           cropSizeContainer.style.display = "none";
//         } else if (handlingOption.value === "square") {
...
//         updateOverlay(); // Ensure overlay is updated based on the new selection
//       }, 10);
//     };
...
//   cropModalCloseButton = document.getElementById("modalCloseButton");
//   cropModalCloseButton.addEventListener("click", closeModal);

//   cropSizeSelector.addEventListener("change", updateOverlay);

//   function initializeOverlay() {
//     const modalRect = modalImageContainer.getBoundingClientRect();
//     overlay.style.width = `${modalRect.width}px`; // Start with full width
//     overlay.style.height = `${modalRect.height}px`; // Start with full height
...
//       case "custom":
//         aspectRatio = null;
//         overlayWidth = width; // Set to full width
//         overlayHeight = height; // Set to full height
//         break;
//       default:
//         overlayWidth = width * 0.8;
//         overlayHeight = height * 0.8;
...
//       if (newWidth + elementRect.left > containerRect.width) {
//         newWidth = containerRect.width - elementRect.left;
//         newHeight = newWidth / (aspectRatio || 1);
//       }
//       if (newHeight + elementRect.top > containerRect.height) {
//         newHeight = containerRect.height - elementRect.top;
//         newWidth = newHeight * (aspectRatio || 1);
//       }
...
//   handlingOption.addEventListener("change", function () {
//     const outputWidthParent = document.getElementById("outputWidth").parentElement;
//     const outputHeightParent = document.getElementById("outputHeight").parentElement;
//     const instructionText = document.getElementById("headerInstruction");
...
//                   ? "Please use the crop tool to crop all images to the Header Background size."
//                   : "Please use the crop tool to crop all images to a 1:1 Square size.";
//               showRatioAlertModal(alertMessage);
//               return;
//             }
...
//     if (selectedFiles.length !== durations.length) {
//       showRatioAlertModal("Mismatch between number of images and durations.");
//       return;
//     }
...
//       .catch(() => {
//         processingNotification.style.display = "none";
//         showRatioAlertModal("Failed to create video. Please try again.");
//       });
//   }
...
//   // Functions to handle the Ratio Alert Modal
//   function showRatioAlertModal(message) {
//     ratioAlertMessage.textContent = message;
...
//   ratioAlertCloseButton.addEventListener("click", closeRatioAlertModal);
